<div>
    ...
    <div class="fixed top-0 right-0 left-72 h-16 bg-gradient-to-r from-blue-800 via-indigo-800 to-indigo-900 shadow-md z-40 px-6">
        <div class="h-full flex items-center justify-end space-x-6">
            <div class="flex items-center space-x-4">
                <a href="{{ route('comunicados.index') }}" class="relative p-2 text-white/80 hover:text-white transition-colors duration-150">
                ...
                <a href="{{ route('profile.index') }}" class="flex items-center space-x-3 p-2 rounded-lg hover:bg-white/5 transition-colors duration-150">
    ...
    <div class="fixed inset-y-0 left-0 w-72 bg-gradient-to-b from-blue-800 to-indigo-900 text-white shadow-xl z-50">
        ...
        <nav class="mt-4 px-3 space-y-1">
            ...
            <a href="{{ route('profile.index') }}" class="flex items-center px-4 py-2.5 {{ request()->routeIs('profile.index') ? 'bg-white/15 text-white' : 'text-white/80 hover:text-white hover:bg-white/10' }} rounded-lg group transition duration-150 ease-in-out">
                <span class="material-symbols-outlined w-8">account_circle</span>
            ...
            <a href="{{ route('crud_departamentos.index') }}" class="flex items-center px-4 py-2.5 {{ request()->routeIs('crud_departamentos.*') ? 'bg-white/15 text-white' : 'text-white/80 hover:text-white hover:bg-white/10' }} rounded-lg group transition duration-150 ease-in-out">
            ...
            <a href="{{ route('documentacion.index') }}" class="flex items-center px-4 py-2.5 {{ request()->routeIs('documentacion.*') ? 'bg-white/15 text-white' : 'text-white/80 hover:text-white hover:bg-white/10' }} rounded-lg group transition duration-150 ease-in-out">
